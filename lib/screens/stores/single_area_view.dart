...
class SingleAreaView extends StatefulWidget {
  const SingleAreaView({Key? key}) : super(key: key);

  @override
  State<SingleAreaView> createState() => _SingleAreaViewState();
}

class _SingleAreaViewState extends State<SingleAreaView> {
